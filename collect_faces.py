# USAGE
# python recognize_faces_image.py --encodings encodings.pickle --images faces --output tested --name name
# python recognize_faces_image.py -e encodings.pickle -i faces -o tested -n name
